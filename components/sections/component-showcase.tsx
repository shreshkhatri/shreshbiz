...
export function ComponentShowcase() {
  ...
  return (
    <section id="components" className="w-full py-24 lg:py-32">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-4 p-6 border rounded-lg glassmorphic-card">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <motion.button
                          className="neumorphic-button inline-flex items-center justify-center whitespace-nowrap  text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-secondary text-secondary-foreground hover:bg-secondary/80 h-9 rounded-md px-3"
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          Small
                        ...
                        <motion.button
                          className="neumorphic-button inline-flex items-center justify-center whitespace-nowrap  text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-secondary text-secondary-foreground hover:bg-secondary/80 h-11 rounded-md px-8"
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          Large
